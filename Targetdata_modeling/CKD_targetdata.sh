...
# tools in /NovaSeq_128/Kenny/tool/bin/
...
${tool_dir}plink --vcf process/indQC_nodup_chr_xym_"$phenoarray".vcf --make-bed --allow-no-sex --out process/indQC_nodup_chr_xym_"$phenoarray"
...
Rscript ${tool_dir}snpQCreport_target.r
